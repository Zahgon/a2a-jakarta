...
/** v1.0 JSON-RPC with per-task ownership checks. */
@SpringBootTest(classes = TaskAuthSuiteApplication.class,
...
class JsonRpcA2AServerWithTaskAuthorizationTest extends AbstractA2AServerWithTaskAuthorizationTest {
