...
/**
 * {@link Compat03SuiteApplication} with BASIC authentication and per-task ownership checks.
 *
...
@Import({SdkTestKitConfiguration.class, Compat03TestKitConfiguration.class, A2ATestController.class,
        SuiteSecurityConfiguration.class, TaskAuthTestKitConfiguration.class})
public class Compat03TaskAuthSuiteApplication {
}
