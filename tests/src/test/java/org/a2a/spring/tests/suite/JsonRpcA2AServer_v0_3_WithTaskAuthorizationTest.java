...
/**
 * Protocol v0.3 JsonRpc with per-task ownership checks, ported from
 * {@code tests/compat-0.3/jsonrpc}'s {@code JakartaA2AServer_v0_3_WithTaskAuthorization} suite.
 *
...
class JsonRpcA2AServer_v0_3_WithTaskAuthorizationTest
    ...
    JsonRpcA2AServer_v0_3_WithTaskAuthorizationTest() {
    ...
    protected void configureTransportWithCredentials(
        ...
        builder.withTransport(JSONRPCTransport_v0_3.class, new JSONRPCTransportConfigBuilder_v0_3().addInterceptor(authInterceptor));
    }
}
