...
/**
 * The protocol v0.3 Rest suite, ported from {@code tests/compat-0.3/rest}.
 *
...
class RestA2AServer_v0_3_Test extends AbstractA2AServerServerTest_v0_3 {

    static {
        SuiteServerPort.publishToAgentCardProducer();
    }

    RestA2AServer_v0_3_Test() {
