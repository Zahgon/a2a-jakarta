...
/**
 * Protocol v0.3 JsonRpc under BASIC authentication, ported from
 * {@code tests/compat-0.3/jsonrpc}'s {@code JakartaA2AServer_v0_3_WithAuth} suite.
 */
...
class JsonRpcA2AServer_v0_3_WithAuthTest extends AbstractA2AServerWithAuthTest_v0_3 {

    static {
        SuiteServerPort.publishToAgentCardProducer();
    }

    JsonRpcA2AServer_v0_3_WithAuthTest() {
